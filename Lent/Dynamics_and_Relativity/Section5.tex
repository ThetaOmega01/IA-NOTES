...
Note that $ \hat{\mathbf{x}} $ is horizontal and \textit{eastward} (i.e. points inside the paper), $ \hat{\mathbf{y}} $ is horizontal and northward, and $ \hat{\mathbf{z}} $ is vertical. At $P$,
\begin{align*}
