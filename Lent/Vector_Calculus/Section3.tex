...
\begin{example}
    ...
    \[
        S = \{\bfx = \bfx(\theta,\phi),\theta\in [0,\pi/2],\phi\in [0,2\pi]\},\quad \bfx(\theta,\phi) = \begin{pmatrix}
...
\begin{definition}
    ...
    \[
        \frac{\partial \bfx}{\partial u} \times \frac{\partial \bfx}{\partial v}\neq \mathbf{0}\quad\text{on }S.  
    \]
    In this case, we can define the \textbf{normal} to $S$ by 
    \[
        \bfn = \frac{\dfrac{\partial \bfx}{\partial u}\times \dfrac{\partial \bfx}{\partial v}  }{\left| \dfrac{\partial \bfx}{\partial u}\times \dfrac{\partial \bfx}{\partial v} \right| }.
    \]
\end{definition}
\begin{note}
...
\begin{center}
    \begin{tikzpicture}[scale = 0.7]
        ...
        \draw [->] (6.center) -- (9.center) node [pos=0, dot=3pt] {} node [above] {$ \bfn $};
        \draw [->] (8.center) -- (10.center) node [pos=0, dot=3pt] {} node [above right] {$ \bfn $};
        \draw [->] (7.center) -- (11.center) node [pos=0, dot=3pt] {} node [above left] {$ \bfn $};
    \end{tikzpicture}    
\end{center}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw [->, in=-105, out=135] (9.center) to (11) node [below] at (9) {$ \bfx(u+\delta u,v)-\bfx(u,v) $};
        \draw [->, bend left=330] (10.center) to (12) node [below] at (10) {$ \bfx(u,v+\delta v)-\bfx(u,v) $};
